      ...
      <div class="build-value-wrapper">
        ...
        <div class="bottom-part">
          ...
          <div class="right-part">
            <nuxt-img src="/img/chart.png" alt="Chart"/>
          </div>
        </div>
      </div>
    </div>
    ...
    .content-part {
      ...
      .record {
        ...
        .image {
          ...
          &.clients {
            background: url('/img/svg/records/clients.png') center / contain no-repeat;
          }

          &.projects {
            background: url('/img/svg/records/projects.png') center / contain no-repeat;
          }

          &.team {
            background: url('/img/svg/records/team.png') center / contain no-repeat;
          }
        }
...
.build-value {
  padding: 50px 0;
  background: linear-gradient(90deg, #3872FF 0%, #A883FF 100%);
