<template>
  <div class="legal-text">
    ...
    <p>Please read these Terms of Use carefully before you use the Service. By installing, using or otherwise accessing
      the Service you agree with the applicability and content of these Terms of Use as well as the applicable privacy
      policy. Certain parts of the Service, such as webpages or portals where you can download games or pay for in-game
      credits, may include additional terms and conditions from us or our suppliers, licensors or other third parties,
      that supplement these Terms of Use. By using those services, you agree to comply with such additional terms and
      conditions. If you do not agree to the Terms of Use, the applicable Privacy Policy or additional terms and
    ...
    <p>2.3. A username is a unique identifier either selected by you or provided by us, and is used to identify you on
      ...
      immediately. You are solely responsible for maintaining the confidentiality of the login details, and for any
    ...
    <p>3.1. The Service may contain content from players (&ldquo;User Generated Content&rdquo;), such as messages, wall
      posts, opinions comments, pictures, or graphics. We are not actively involved in the creation nor publication of
      such User Generated Content, and we do not endorse any User Generated Content, nor do we warrant that such content
    ...
    <p>3.2. If you submit any User Generated Content yourself, you grant Gammeon a non-exclusive, irrevocable,
      ...
      means and in all forms of media, now known or hereafter developed. To the extent permitted by applicable laws, you
      hereby waive any moral rights or rights of publicity or privacy you may have regarding such User Generated
      Content.</p>
    <p>3.3. Without prejudice to 3.2, you will retain possible ownership in your User Generated Content. We reserve the
      right to monitor any User Generated Content and your activities in connection with the Service, but cannot monitor
      or prescreen all of the User Generated Content and do not attempt to do so. We have the right, but not the
      obligation, to edit, refuse to post, or remove any User Generated Content posted on the Service at our own
      discretion, for any reason whatsoever at any time.</p>
    ...
    <p>4.2. The Service may include links to websites of third parties, including links provided as automated search
      ...
      acknowledge and agree that we are not responsible or liable for any content or other materials on these
      third-party sites.</p>
    <p><strong>5. CONDUCT ON THE SERVICE</strong></p>
    <p>5.1. You may use the Service offered on it only for lawful, personal, non-commercial purposes. To the extent any
      content is available for downloading, such content may only be downloaded for personal use, and may not be further
    ...
    <ol>
      ...
      <li>use the Service in a manner that exceeds the rights granted for your use;</li>
      <li>use the Service for any data mining, robots, or similar data-gathering and -extraction tools on the content;
        frame any portion of the Service
      </li>
      <li>reproduce, copy, adjust, display, modify, translate, port, publish, (sub)license, transfer, or otherwise
        distribute or exploit the content available on the Service without our prior written consent;
      </li>
      ...
      <li>transmit, directly or indirectly, any unsolicited bulk communications (including emails and instant messages)
        through the Service;
      </li>
      <li>use the Service in a manner that could damage, disable, or overburden our servers or networks;</li>
      <li>interfere with any other party&apos;s use and enjoyment of the Service; or</li>
      <li>circumvent any mechanisms included in the Service for preventing the unauthorized reproduction or distribution
        of any content on the Service.
      </li>
    </ol>
    <p>5.3. You may not submit or transmit through the Service any information, content, or material or otherwise engage
      in any conduct that:</p>
    <ol>
      <li>violates or infringes the rights of others, including, without limitation, patent, trademark, trade secret,
        copyright, publicity, or other proprietary rights;
      </li>
      <li>is unlawful, threatening, abusive, harassing, defamatory, libelous, deceptive, fraudulent, invasive of another&apos;s
        privacy, tortuous, contains explicit or graphic descriptions or accounts of sexual acts, or is pornographic;
      </li>
    ...
    <p>6.1. Within certain games on the Service you may purchase a limited, personal, non-transferable,
    ...
    <p>There is no right for refund or other compensation for unused Paid Services in this respect.</p>
    ...
    <p>7.2 We may make Content available for you to download or use. Such Content will be subject to the terms of the
      ...
      Content. We grant you a personal, nonexclusive, nontransferable, limited license to install the Content on any
      single computer or device. The Content is protected by copyright and other intellectual property laws and treaties
      and is owned by us or our licensors. You may not sell or redistribute the Content. You may not incorporate it or
      any portion of it into another product. You may not reverse engineer, decompile, or disassemble the software or
      otherwise attempt to derive the source code (except where expressly permitted by law). You may not modify, adapt,
      or create derivative works from the software in any way or remove proprietary notices in the software. You agree
      to abide by all laws and regulations regarding your use of the Content. You may not authorize or assist any third
      party to do any of the things prohibited in this paragraph. We may automatically check your version of the Content
    ...
    <p>8.1 We provide the Service &lsquo;AS IS&rsquo;, with all faults and as available. We and our licensors make no
      ...
      available at all times. We do not guarantee that the results that may be obtained from the use of the Service
    ...
    <p>8.3. We make no representation that any Service is appropriate or available for use in locations outside the
      Netherlands. If you choose to access the Service from a location outside the Netherlands, you do so on your own
      initiative and you are responsible for compliance with local laws.</p>
    <p>The foregoing does dot prejudice the limitations of liability and the indemnifications, elsewhere in these terms
      conditions.</p>
    <p>8.4. If in your view any copyright or other intellectual property right (&ldquo;IP right&rdquo;) that you may
      have is being infringed by/on the Service, please inform us of hereof immediately, thereby providing us with:</p>
    <ol>
      <li>the electronic or physical signature of the owner of the IP right or the person authorized to act on the owner&apos;s
        behalf.
      </li>
      <li>a description of the IP right that you claim has been infringed and a description of the infringing
        activity.
      </li>
      <li>identification of the location where the original or an authorized copy of the copyrighted work exists, for
        example the URL of the website where it is posted or the name of the book in which it has been published or in
        case of a registered brand name, an excerpt of such register evidencing the registry.
      </li>
      <li>if you are not the owner of the IP right, a copy of a license in which you are granted the right to use and to
        protect such IP right.
      </li>
      <li>identification of the URL or other specific location on this site where the material that you claim is
        infringing is located; this information must be specific enough in order to enable us to localize such material.
      </li>
    ...
    <p>Upon a request by us, you agree to defend, indemnify, and hold harmless us and our parent and other affiliated
      ...
      claims, and expenses, including attorney&apos;s fees that arise from your use or misuse of the Service. We reserve
      the right, at our own expense, to assume the exclusive defense and control of any matter otherwise subject to
      indemnification by you, in which event you will cooperate with us in asserting any available defenses.</p>
    <p><strong>10. MISCELLANEOUS</strong></p>
    <p>10.1. This contract and any supplemental terms, policies, rules, and guidelines posted on the Service constitute
      the entire agreement between you and us and supersede all previous written or oral agreements. If any part of
      these Terms of Use is held invalid or unenforceable, that portion shall be construed in a manner consistent with
      applicable law to reflect, as nearly as possible, the original intentions of the parties, and the remaining
      portions shall remain in full force and effect.</p>
    <p>10.2. You agree that we may electronically provide to you required notices, agreements, and other information
      concerning the Service. If you no longer agree to receive notices electronically, please cease using the Service
      and/or expunge the Service from your computer or device.</p>
    <p>10.3. We may change these Terms of Use and will provide notice thereof via the Service. The most recent version
      of these terms shall at all times be accessible via the Service. You are responsible for checking these Terms of
      Use periodically for changes. If you continue to use the Service after the changes to these Terms of Use have come
    ...
    <p>10.6. You acknowledge that the rights granted and obligations made under these Terms of Use to Gammeon are of a
      ...
      issued in connection therewith, or exploitation of the Service or any content or other material used or displayed
      through the Service and agree to limit your claims to claims for monetary damages.</p>
  </div>
</template>
