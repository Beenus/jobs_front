  ...
  async asyncData({store, route, from, error}) {
    ...
    return {
      ...
      description: '<p>In today\'s competitive job market, it\'s critical to arm yourself with the right tools to find the perfect career opportunity. Long gone are the days of scouring newspaper classifieds or hopping from company to company dropping off résumés. The job search process has evolved, becoming digitized and more efficient than ever before.</p>' +
        ...
        '<p>Our platform offers a dedicated page for work from home opportunities, perfect for those seeking flexibility and balance between professional and personal life. We curate remote jobs across various industries, helping you find a role that allows you to excel professionally from the comfort of your home.</p>' +
        '<h3>Caregiver Jobs</h3>' +
        '<p>For those inclined towards making a difference in other\'s lives, our extensive list of caregiver jobs is just a click away. With roles ranging from child care to elderly care, we can connect you to positions that align with your caregiving skills and passion.</p>' +
        '<h3>Driver Jobs</h3>' +
        '<p>If you enjoy being on the road and have the necessary qualifications, our driver jobs page offers a wide range of opportunities. From delivery drivers to commercial truck operators, we can help you steer your career in the right direction.</p>' +
        '<h3>Warehouse Jobs</h3>' +
        '<p>For those seeking roles in logistics and supply chain, check out our warehouse jobs page. We provide an array of positions, from entry-level to management, in various locations.</p>' +
        '<h3>Administrative Jobs</h3>' +
        '<p>Our administrative jobs page is the go-to resource for professionals looking for roles in office management, secretarial tasks, or executive assistance. With our vast collection of opportunities, your next administrative role could be just a search away.</p>' +
        '<h3>Part-Time and Full-Time Jobs</h3>' +
        '<p>Whether you\'re looking for a side gig or a full-time commitment, we have you covered. Visit our part-time jobs or full-time jobs pages to find positions that suit your availability and income needs.</p>' +
        '<h3>Nurse Jobs</h3>' +
        '<p>For those in the healthcare industry, our nurse jobs page is a valuable resource. We connect registered nurses, nurse practitioners, and other healthcare professionals with institutions in dire need of their expertise.</p>' +
